...
import {
  ...
  Folder, FolderPlus, Heading2, Italic, Link2, List, ListOrdered, LogOut, Menu,
  MoreHorizontal, Moon, Plus, Quote, Search, Sun, Trash2, X,
} from 'lucide-react'
